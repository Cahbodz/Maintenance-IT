                ...
                <div class="x_content">
                  ...
                  <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                      <div class="progress">
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 40%;">
                          <span class="sr-only">60% Complete</span>
                        </div>
                      </div>
                    </div>
                    <div class="w_right w_20">
                      <span><?= $this->db->get('tb_toner')->num_rows();?> unit</span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <div class="widget_summary">
                    ...
                    <div class="w_right w_20">
                      <span><?= $this->db->get('tb_ram')->num_rows(); ?> unit</span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="widget_summary">
