        ...
        <div class="col-md-12 col-sm-12 ">
            ...
            <?php
                    ...
                    <td style="text-align:center" width="200px">
                        ...
                        <a class="btn btn-info" href="<?php echo base_url(); ?>printer/read/<?php echo $printer->id_printer ?>"><span class="glyphicon glyphicon-eye-open" ></span></a>

                        <a class="btn btn-warning" href="<?php echo base_url(); ?>printer/update/<?php echo $printer->id_printer ?>"><span class="glyphicon glyphicon-pencil" ></span></a>
                         
                        <a class="btn btn-danger" href="<?php echo base_url(); ?>printer/delete/<?php echo $printer->id_printer ?>"><span class="glyphicon glyphicon-trash" onclick="return confirm('yakin data dihapus?')"></span></a>
