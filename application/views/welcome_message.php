    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>John Doe <b> <?php echo $this->session->userdata('username'); ?> </b></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Log maintenens <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url("Log_kom")?>">Form Komputer</a></li>
                      <li><a href="<?php echo base_url("Log_printer")?>">Form printer</a></li>
                  ...
                  <li><a><i class="fa fa-home"></i> Hardware Cadangan  <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo base_url("login/logout.php"); ?>">
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Komputer</span>
              <div class="count"><?= $this->db->get('tb_komputer')->num_rows();?></div>
              <span class="count_bottom"><i class="green">4% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Jumlah Ups terpakau</span>
        ...
        <footer>
          ...
          <p style="margin-right: 500px; color: black;">Copyright @ 2021<a href="https://www.gemainsani.co.id/">Gemainsani - IT Support</a></p>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
